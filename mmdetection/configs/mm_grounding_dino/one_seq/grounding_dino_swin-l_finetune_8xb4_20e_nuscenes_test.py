...
class_name = ('car', 'truck', 'trailer', 'container', 'bus', 
...
val_dataloader = dict(
    ...
    dataset=dict(
        metainfo=metainfo,
        data_root=data_root,
        ann_file='test_val_0_seq.json',
        data_prefix=dict(img='images_val_0_seq/')))

test_dataloader = val_dataloader

val_evaluator = dict(
    ann_file=data_root + 'test_val_0_seq.json',
    outfile_prefix=data_root + 'outputs/result_2D_0_seq',
    # format_only=True
    )
