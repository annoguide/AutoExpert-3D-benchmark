...
if __name__ == "__main__": 
    ...
    argparser.add_argument(
        "--prediction_sorted_json_path", default=None)
    argparser.add_argument(
    ...
    if config.prediction_sorted_json_path != None:
        with open(config.prediction_sorted_json_path, 'w') as f:
            json.dump(predictions_sorted, f) 
    ...
    for raw_label in raw_labels:
        ...
        points_path_list = []
        if token_name in predictions_sorted['results']:
